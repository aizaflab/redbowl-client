    ...
    const defaultOptionRenderer = (option, isSelected, isHighlighted) => (
      <div
        className={cn(
          ...
          isSelected
            ? "bg-gray-100/80 dark:bg-primary text-primary dark:text-gray-200 justify-between hover:dark:bg-primary"
      ...
      >
        ...
        <div className="relative">
          <button
            type="button"
            className={cn(
              "flex h-10 w-full items-center justify-between rounded-md border border-main  px-3 py-2 text-sm ring-offset-background focus:outline-none  disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer dark:bg-transparent dark:border-main/50 dark:font-[350]",
              startIcon && "pl-10",
          ...
          >
            ...
            {endIcon ? (
              ...
              <span className={`flex items-center text-main/50`}>
                <Icon
                  icon="icon-park-outline:up"
                  className={`ani3 text-lg ${
                    isOpen ? "rotate-0" : "rotate-180"
                  }`}
                />
              </span>
        ...
        {dropdownStyle.top > 0 &&
          ...
          createPortal(
            <div
              ...
              ref={optionsRef}
            >
              <div className="max-h-60 overflow-auto sideBar rounded-md p-1.5 space-y-1 bg-white dark:bg-[#1A2A2F]">
                {options.length === 0 ? (
